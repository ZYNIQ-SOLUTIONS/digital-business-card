...
class SvgBuilder {
  ...
  <g id="zavatar-root">
    ...
    static getDefaultOutfitColor(outfit) {
        switch (outfit) {
    ...
    static renderBackHair(hairStyle, hairColor) {
    ...
    static renderHeadAndEars(faceShape, skinTone, jawScale) {
    ...
    static renderOutfit(outfit, outfitColor, skinTone) {
        switch (outfit) {
            case 'business-formal':
    ...
    static renderExpression(expression, eyeScale) {
        let eyebrows = '';
        let eyes = '';
        let mouth = '';
        switch (expression) {
    ...
    static renderFrontHair(hairStyle, hairColor) {
        switch (hairStyle) {
            case 'short-straight':

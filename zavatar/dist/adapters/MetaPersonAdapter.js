...
exports.MetaPersonAdapter = void 0;
/**
...
class MetaPersonAdapter {
    ...
    constructor(apiKey, endpoint) {
        ...
        if (!this.apiKey) {
            throw new Error('MetaPersonAdapter: METAPERSON_API_KEY environment variable is not set. ' +
    ...
    async generateFromSelfie(image, style) {
        ...
        throw new Error('MetaPersonAdapter.generateFromSelfie is a stub for Avatar SDK Cloud API integration. ' +
    ...
    async generateFromTemplate(params) {
        ...
        // });
        throw new Error('MetaPersonAdapter.generateFromTemplate is a stub for Avatar SDK Cloud API integration. ' +
            'Configure valid MetaPerson credentials or fallback to TemplateAdapter.');
    }
}
exports.MetaPersonAdapter = MetaPersonAdapter;
//# sourceMappingURL=MetaPersonAdapter.js.map
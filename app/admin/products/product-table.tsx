      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="bg-gray-50 border-b border-gray-100">
            ...
            <th className="px-6 py-4 text-sm font-medium text-gray-500">Price (AED / USD)</th>
        ...
        <tbody className="divide-y divide-gray-100">
          {products.map((product) => {
            const aed = Number(product.price);
            const usd = (aed / USD_TO_AED_RATE).toFixed(2);
            ...
            return (
              <tr key={product.id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-6 py-4 font-medium">
                  <div className="text-gray-900 font-bold">AED {aed.toFixed(2)}</div>
                  <div className="text-xs text-gray-400 font-semibold">${usd} USD</div>
                </td>
                <td className="px-6 py-4">
                  <select

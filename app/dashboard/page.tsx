  ...
  if (loading) {
    return (
      <div className="py-24 flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-sm text-neutral-500">Loading your digital cards...</p>
      </div>
    );
  }
    ...
    return (
      <div className="py-24 flex flex-col items-center justify-center text-center space-y-5">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-neutral-500 max-w-sm mx-auto">Create your first digital business card to start networking smarter and sharing your professional identity.</p>
        </div>
        <Link
          href="/dashboard/cards/new"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md bg-neutral-900 hover:bg-neutral-800 text-white text-sm font-medium shadow-sm transition-all focus:ring-2 focus:ring-neutral-900/20 focus:outline-none"
        >
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Link
          href="/dashboard/cards/new"
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-md bg-neutral-900 hover:bg-neutral-800 text-white text-sm font-medium shadow-sm transition-all focus:ring-2 focus:ring-neutral-900/20 focus:outline-none"
        >
          <Plus className="w-4 h-4" />
          <span>Create New Card</span>
        </Link>
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-neutral-500">{card.company}</p>
              </div>

              {/* QR Preview Trigger */}
              <button
                onClick={() => setQrModalCard(card)}
                className="p-2.5 rounded-xl bg-neutral-100 hover:bg-neutral-200 text-neutral-600 transition-colors focus:outline-none"
                title="View QR Code"
              >
            ...
            <div className="pt-4 border-t border-neutral-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 text-xs font-medium text-neutral-900 transition-colors"
                >
                ...
                <select
                  ...
                  className="px-2 py-1.5 rounded-lg text-xs font-medium bg-neutral-100 border border-transparent text-neutral-900 hover:bg-neutral-200 transition-colors focus:outline-none cursor-pointer"
                ...
                <select
                  ...
                  className="px-2 py-1.5 rounded-lg text-xs font-medium bg-neutral-100 border border-transparent text-neutral-900 hover:bg-neutral-200 transition-colors focus:outline-none cursor-pointer hidden sm:block"
                  title="Card Theme"
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg text-xs font-medium text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100 transition-colors hidden sm:block"
                >
              ...
              <button
                ...
                className="p-1.5 rounded-lg text-neutral-400 hover:text-red-600 hover:bg-red-50 transition-colors focus:outline-none"
                title="Delete Card"
              >
